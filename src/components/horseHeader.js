...
const ImageHeader = props => (
    <ImageBackground 
       style={{width: '100%', height: 50, position: 'absolute', top: 0, left: 0,marginTop:16,flexDirection:'row'
       }}
      ...
      {props.menu ==='hammer' ? 
        ...
        containerViewStyle={{backgroundColor:'transparent', width:45,height: '100%',position:'relative',
        right:15}}
        /> : 
        <Button 
      ...
      {props.menu ==='hammer' ?  
      <Text style={{backgroundColor:'transparent', color:'#6E6E6E', alignSelf:'center', 
      fontSize: 15,marginLeft:'10%',fontWeight:'bold'}}>{props.title}</Text>
      :
