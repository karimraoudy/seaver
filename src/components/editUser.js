...
import {updateProfile, distanceSelected,burnCalSelected, weightSelected,
  FirstChanged, lastChanged, weightChanged,languageChanged} from '../actions';
...
class EditUser extends Component {
  ...
  onSubmit=()=>{
    ...
    this.props.updateProfile({ email, firstName, lastName,weight, distanceUnit,
...
export default connect(mapStateToProps,{updateProfile, distanceSelected,burnCalSelected, weightSelected,
  FirstChanged, lastChanged, weightChanged,languageChanged})(EditUser);
